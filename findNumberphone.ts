function findNumerPhones(phones: string = '') {
...
//add number to service providers
    ...
    let phones: string = '0352222657164646455454257143684268137543645138412842814837458314524185436284128416841362841368421867163386436817243873816984168';
    let newArr: string[] = [];
